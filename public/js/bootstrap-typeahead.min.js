...
!function(a) {
    ...
    var b = function(b, c) {
        ...
        c.scrollBar && (c.items = 100,
            c.menu = '<ul class="typeahead dropdown-menu" style="max-height:220px;overflow:auto;"></ul>');
        var d = this;
        if (d.$element = a(b),
                d.options = a.extend({}, a.fn.typeahead.defaults, c),
                d.$menu = a(d.options.menu).insertAfter(d.$element),
                d.eventSupported = d.options.eventSupported || d.eventSupported,
                d.grepper = d.options.grepper || d.grepper,
                d.highlighter = d.options.highlighter || d.highlighter,
                d.lookup = d.options.lookup || d.lookup,
                d.matcher = d.options.matcher || d.matcher,
                d.render = d.options.render || d.render,
                d.onSelect = d.options.onSelect || null,
                d.sorter = d.options.sorter || d.sorter,
                d.source = d.options.source || d.source,
                d.displayField = d.options.displayField || d.displayField,
                d.valueField = d.options.valueField || d.valueField,
                d.autoSelect = d.options.autoSelect || d.autoSelect,
                d.options.ajax) {
            var e = d.options.ajax;
            "string" == typeof e ? d.ajax = a.extend({}, a.fn.typeahead.defaults.ajax, {
                url: e
            }) : ("string" == typeof e.displayField && (d.displayField = d.options.displayField = e.displayField),
            "string" == typeof e.valueField && (d.valueField = d.options.valueField = e.valueField),
                d.ajax = a.extend({}, a.fn.typeahead.defaults.ajax, e)),
            d.ajax.url || (d.ajax = null),
                d.query = ""
        } else
            d.source = d.options.source,
                d.ajax = null;
        d.shown = !1,
            d.listen()
    };
    b.prototype = {
        ...
        ajaxLookup: function() {
            function b() {
                ...
                var b = this.ajax.preDispatch ? this.ajax.preDispatch(c) : {
                    query: c
                };
            ...
            return c === this.query ? this : (this.query = c,
            this.ajax.timerId && (clearTimeout(this.ajax.timerId),
                this.ajax.timerId = null),
                !c || c.length < this.ajax.triggerLength ? (this.ajax.xhr && (this.ajax.xhr.abort(),
                    this.ajax.xhr = null,
                    this.ajaxToggleLoadClass(!1)),
                    this.shown ? this.hide() : this) : (this.ajax.timerId = setTimeout(a.proxy(b, this), this.ajax.timeout),
                    this))
        },
        ajaxSource: function(a) {
            ...
            var b, c = this;
            if (c.ajax.xhr)
                return c.ajax.preProcess && (a = c.ajax.preProcess(a)),
                    c.ajax.data = a,
                    b = c.grepper(c.ajax.data) || [],
                    b.length ? (c.ajax.xhr = null,
        ...
        lookup: function(a) {
            var b, c = this;
            return c.ajax ? void c.ajaxer() : (c.query = c.$element.val(),
                c.query && (b = c.grepper(c.source)) ? (0 == b.length && (b[0] = {
                    id: -21,
        ...
        render: function(b) {
            ...
            return b = a(b).map(function(b, f) {
                return "object" == typeof f ? (c = e ? f[d.options.displayField] : d.options.displayField(f),
                    b = a(d.options.item).attr("data-value", f[d.options.valueField])) : (c = f,
                    b = a(d.options.item).attr("data-value", f)),
                    b.find("a").html(d.highlighter(c)),
                    b[0]
            }),
            d.autoSelect && b.first().addClass("active"),
                this.$menu.html(b),
                this
        },
        grepper: function(b) {
            ...
            if (b[0].hasOwnProperty(e.options.displayField))
                c = a.grep(b, function(a) {
                    return d = f ? a[e.options.displayField] : e.options.displayField(a),
                        e.matcher(d)
                });
            else {
        ...
        next: function(b) {
            var c = this.$menu.find(".active").removeClass("active")
                , d = c.next();
            if (d.length || (d = a(this.$menu.find("li")[0])),
        ...
        destroy: function() {
            ...
            this.eventSupported("keydown") && this.$element.off("keydown", a.proxy(this.keydown, this)),
